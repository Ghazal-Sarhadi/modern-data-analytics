...
input_path = Path("model_outputs/station_month_bike_crash_dataset_1km.csv")
output_path = Path("model_outputs/station_month_bike_crash_dataset_1km_next_month.csv")
