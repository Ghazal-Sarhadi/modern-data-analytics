...
APP_ASSETS_DIR = EXPERIMENT_DIR / "app_assets"
MODELS_DIR = EXPERIMENT_DIR / "models"
TEMPLATE_DIR = EXPERIMENT_DIR / "web" / "templates"
STATIC_DIR = EXPERIMENT_DIR / "web" / "static"
...
class GroupedAppState:
    def __init__(self) -> None:
        ...
        if missing:
            raise RuntimeError(
                "Missing grouped app assets. Run export_grouped_app_model.py and build_grouped_app_assets.py first. "
                + ", ".join(missing)
            )
